...
impl AutoMeltTier {
    ...
    pub fn color(&self) -> Color {
        match self {
            AutoMeltTier::Off => Color::Rgb(120, 120, 120), AutoMeltTier::Trash => Color::Rgb(160, 160, 160),
            AutoMeltTier::Fine => Color::Rgb(0, 255, 127), AutoMeltTier::Rare => Color::Rgb(0, 229, 255),
            AutoMeltTier::Epic => Color::Rgb(138, 43, 226), AutoMeltTier::All => Color::Rgb(255, 0, 85),
        }
    }
}
...
impl AutoListTier {
    ...
    pub fn color(&self) -> Color {
        match self {
            AutoListTier::Off => Color::Rgb(120, 120, 120), AutoListTier::All => Color::Rgb(220, 220, 220),
            AutoListTier::Fine => Color::Rgb(0, 255, 127), AutoListTier::Rare => Color::Rgb(0, 229, 255),
            AutoListTier::Epic => Color::Rgb(138, 43, 226), AutoListTier::Legendary => Color::Rgb(255, 215, 0),
        }
    }
}
...
impl GameState {
    ...
    pub fn new() -> Self {
        let mut s = Self {
            ...
            master_shattered_count: 0, apprentice_shattered_count: 0, missed_encounter_count: 0,
        };
