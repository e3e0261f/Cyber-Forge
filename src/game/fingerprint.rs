...
impl Fingerprint64 {
    ...
    pub fn to_base62(mut num: u64) -> String {
        ...
        format!(
            "#{}",
            String::from_utf8(buf).unwrap_or_else(|_| "Z7kQ9m".into())
        )
    }
    ...
    pub fn decode(fp: u64, creator_name: &str) -> BirthCertificate {
        ...
        // 还原道德经印记
        let dao_stamp = DAO_DE_JING_STAMPS
            [stamp_idx.min((DAO_DE_JING_STAMPS.len() - 1) as u64) as usize]
            .to_string();
        ...
        BirthCertificate {
            ...
            location_str,
            dao_stamp,
            creator: if creator_name.is_empty() {
                "纯阳真仙".into()
            } else {
                creator_name.into()
            },
