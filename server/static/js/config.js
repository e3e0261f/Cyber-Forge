...
export const gameConfig = {
    ...
    // 🌟 规范化导航快捷键：[L]世界图谱 [M]区域地图 [B]锦囊 [P]拍阁 [J]任务 [N]学徒 [I]日志 [C]身体 [F3]调试 [系统]设置
    navButtons: [
        { id: 'map_world', targetModal: 'map', tab: 'world', label: '🗺️ 九州(L)', color: '#00ffc8', defaultKey: 'KeyL' },
        { id: 'map_zone', targetModal: 'map', tab: 'zone', label: '🧭 区域(M)', color: '#38bdf8', defaultKey: 'KeyM' },
    ...
    excludeHoldKeys: ['KeyP', 'KeyH', 'Digit0', 'Escape', 'KeyL', 'KeyM', 'KeyB', 'KeyJ', 'KeyN', 'KeyI', 'KeyC']
};
